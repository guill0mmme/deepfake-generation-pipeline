...
models = {
    "face_detector": model(
        url="https://github.com/tsyncIO/model-weights-faceswap/releases/download/v1.0.0/face_detector_scrfd_10g_bnkps.onnx",
        model=FaceDetector,
    ),
    "arcface": model(
        url="https://github.com/tsyncIO/model-weights-faceswap/releases/download/v1.0.0/arcface_net.jit",
        model=FaceId,
    ),
    "generator_224": model(
        url="https://github.com/tsyncIO/model-weights-faceswap/releases/download/v1.0.0/simswap_224_latest_net_G.pth",
    ...
    "parsing_model": model(
        url="https://github.com/tsyncIO/model-weights-faceswap/releases/download/v1.0.0/parsing_model_79999_iter.pth",
        model=BiSeNet,
    ),
    "gfpgan": model(
        url="https://github.com/tsyncIO/model-weights-faceswap/releases/download/v1.0.0/GFPGANv1.4_ema.pth",
        model=GFPGANer,
    ),
    "blend_module": model(
        url="https://github.com/tsyncIO/model-weights-faceswap/releases/download/v1.0.0/blend_module.jit",
        model=BlendModule
    )
}
